...
describe('ErrorPageComponent', () => {
  ...
  // spied upon the getStatusInternet from internet service and after calling the function just checked if it is setting values
  ...
  // spied upon the dialog open method and checked if it is getting called
  ...
  // spied upon the router navigate method and checked if it is getting called or not
