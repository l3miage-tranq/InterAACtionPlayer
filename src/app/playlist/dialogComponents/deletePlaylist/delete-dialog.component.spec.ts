...
describe('DeleteDialogComponent', () => {
  ...
  // added spies on the dialog closeAll method and checked if it is getting called or not
  ...
  // added spies on the dialog and saveService methods and checked if it is getting called or not
